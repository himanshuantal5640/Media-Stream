...
//   }
//   if(!videoDetails){
//     return <div className="text-black dark:text-white text-center py-20">Loading...</div>
//   }
...
export default function Watch() {
  ...
  useEffect(() => {
    ...
    async function fetchVideo() {
      try {
        ...
        if (!ignore) setError("Failed to load video");
        console.error(err);
      } finally {
  ...
  // ---------------- UI ----------------
  return (
    <div className="text-black dark:text-white max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-3 gap-6">
